import{_ as n,c as a,a0 as p,o as e}from"./chunks/framework.Dz46SkuX.js";const m=JSON.parse('{"title":"JSAPI_CORE","description":"","frontmatter":{"layout":"doc"},"headers":[],"relativePath":"jsapi_sqlite3.md","filePath":"jsapi_sqlite3.md"}'),t={name:"jsapi_sqlite3.md"};function l(i,s,r,o,c,u){return e(),a("div",null,s[0]||(s[0]=[p(`<h1 id="jsapi-core" tabindex="-1">JSAPI_CORE <a class="header-anchor" href="#jsapi-core" aria-label="Permalink to &quot;JSAPI_CORE&quot;">​</a></h1><p>内核基本功能</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    def get_info(self) -&gt; Dict[str, str]:</span></span>
